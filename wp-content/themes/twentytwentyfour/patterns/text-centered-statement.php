...
<div class="wp-block-group alignfull has-base-2-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-text-align-center has-heading-font-family has-x-large-font-size" style="font-style:normal;font-weight:400;line-height:1.2"><br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function wp_kses_post() in /opt/lampp/htdocs/f/wp-content/themes/twentytwentyfour/patterns/text-centered-statement.php:20
Stack trace:
#0 {main}
  thrown in <b>/opt/lampp/htdocs/f/wp-content/themes/twentytwentyfour/patterns/text-centered-statement.php</b> on line <b>20</b><br>
</p>
</div>
</div>