	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:50%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<p class="has-heading-font-family has-x-large-font-size" style="line-height:1.2"><br>
<b>Fatal error</b>:  Uncaught Error: Call to undefined function esc_html_x() in /opt/lampp/htdocs/f/wp-content/themes/twentytwentyfour/patterns/text-title-left-image-right.php:20
Stack trace:
#0 {main}
  thrown in <b>/opt/lampp/htdocs/f/wp-content/themes/twentytwentyfour/patterns/text-title-left-image-right.php</b> on line <b>20</b><br>
</p>
</div>
</div>
</div>
